...
// Отложенная загрузка Meta Pixel и TikTok Pixel (strategy=afterInteractive),
// только если заданы env-id. Ничего не грузим, если id нет — важно для латентности в Индонезии.
